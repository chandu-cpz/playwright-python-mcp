...
This package gives MCP clients browser automation tools backed by Python Playwright. It aims to stay close to the official Playwright MCP public contract, with documented Python-specific divergences.
...
| `--output-mode` | Return text artifacts inline with `stdout` or by file reference with `file`. |
