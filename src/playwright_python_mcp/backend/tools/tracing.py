...
tracing_tools = [
    Tool(name="browser_start_tracing", capability="tracing", handler=_handle_start_tracing),
    Tool(name="browser_stop_tracing", capability="tracing", handler=_handle_stop_tracing),
]
