...
test('browser_click (double)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    code: `await page.get_by_role("heading", name="Click me").dblclick()`,
...
test('browser_click (right)', async ({ client, server }) => {
  ...
  expect(result).toHaveResponse({
    code: `await page.get_by_role("button", name="Menu").click(button="right")`,
...
test('browser_click (modifiers)', async ({ client, server, mcpBrowser }) => {
  ...
  if (process.platform !== 'darwin') {
    expect(await client.callTool({
      ...
      code: `await page.get_by_role("button", name="Submit").click(modifiers=["Control"])`,
  ...
  expect(await client.callTool({
    ...
    code: `await page.get_by_role("button", name="Submit").click(modifiers=["Shift"])`,
  ...
  expect(await client.callTool({
    ...
    code: `await page.get_by_role("button", name="Submit").click(modifiers=["Shift", "Alt"])`,
...
test('browser_click (test id attribute)', async ({ startClient, server, mcpBrowser }) => {
  ...
  expect(await client.callTool({
    ...
    code: `await page.get_by_test_id("submit").click()`,
  });
});
