...
test('browser_fill_form (textbox)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    code: `await page.get_by_role("textbox", name="Name").fill("John Doe")
await page.get_by_role("textbox", name="Email").fill("john.doe@example.com")
await page.get_by_role("slider", name="Age").fill("25")
await page.get_by_label("Choose a country United").select_option(label="United States")
await page.get_by_role("checkbox", name="Subscribe to newsletter").set_checked(True)`,
  });
