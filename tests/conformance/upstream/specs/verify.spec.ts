...
test('browser_verify_element_visible', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_role("button", name="Submit")).to_be_visible()`,
  });
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_role("heading", name="Welcome")).to_be_visible()`,
  });
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_role("alert", name="Success message")).to_be_visible()`,
  });
});
...
test('browser_verify_text_visible', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_text("Hello world")).to_be_visible()`,
  });
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_text("Welcome to our site")).to_be_visible()`,
  });
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_text("Status: Active")).to_be_visible()`,
  });
});
...
test('browser_verify_text_visible (with quotes)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_text("She said \\"Hello world\\"")).to_be_visible()`,
  });
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: `await expect(page.get_by_text("It's a beautiful day")).to_be_visible()`,
  });
});
...
test('browser_verify_list_visible', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.locator("body")).to_match_aria_snapshot("- list:\\n  - listitem: \\"Apple\\"\\n  - listitem: \\"Banana\\"\\n  - listitem: \\"Cherry\\"")`),
  });
});
...
test('browser_verify_value (textbox)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("textbox", name="Name")).to_have_value("John Doe")`),
  });
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("textbox", name="Email")).to_have_value("john@example.com")`),
  });
});
...
test('browser_verify_value (checkbox checked)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("checkbox")).to_be_checked()`),
  });
});
...
test('browser_verify_value (checkbox unchecked)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("checkbox")).not_to_be_checked()`),
  });
});
...
test('browser_verify_value (radio checked)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("radio", name="Red")).to_be_checked()`),
  });
});
...
test('browser_verify_value (slider)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("slider")).to_have_value("75")`),
  });
});
...
test('browser_verify_value (combobox)', async ({ client, server }) => {
  ...
  expect(await client.callTool({
    ...
    result: 'Done',
    code: expect.stringContaining(`await expect(page.get_by_role("combobox")).to_have_value("United States")`),
  });
});
